...
<svg viewBox="0 0 780 420" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Spatial cursor pagination request lifecycle diagram" style="max-width:100%;height:auto;display:block;margin:1.5rem 0;">
  ...
  <rect x="0" y="0" width="780" height="420" rx="10" fill="var(--surface, #f5f3ff)"/>
  <defs>
...
The case against OFFSET is not stylistic — it is that its cost grows with how deep the reader has gone.

<svg viewBox="0 0 720 266" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Time to fetch page N of a 400 000 row result: OFFSET, page 1 6 ms, OFFSET, page 50 74 ms, OFFSET, page 500 690 ms, OFFSET, page 2000 2 740 ms, keyset, any page 7 ms — flat" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;">
  <title>Time to fetch page N of a 400 000 row result</title>
  <desc>A horizontal bar chart. OFFSET, page 1 is 6 ms. OFFSET, page 50 is 74 ms. OFFSET, page 500 is 690 ms. OFFSET, page 2000 is 2 740 ms. keyset, any page is 7 ms — flat. OFFSET re-reads and discards every preceding row; keyset seeks straight to the cursor. The gap grows with depth, not with page size.</desc>
  <rect x="0" y="0" width="720" height="266" rx="10" fill="var(--surface, #f5f3ff)"/>
  <text x="20" y="28" font-size="12.5" font-weight="700" fill="currentColor">Time to fetch page N of a 400 000 row result</text>
  <text x="20" y="61" font-size="10.5" fill="currentColor">OFFSET, page 1</text>
  <rect x="250" y="48" width="6" height="18" rx="3" fill="var(--viz-good, #1f6b3a)" opacity="0.75"/>
  <text x="264" y="61" font-size="10" font-weight="700" fill="var(--viz-good, #1f6b3a)">6 ms</text>
  <text x="20" y="95" font-size="10.5" fill="currentColor">OFFSET, page 50</text>
  <rect x="250" y="82" width="9" height="18" rx="3" fill="var(--viz-warn, #8a5000)" opacity="0.75"/>
  <text x="267" y="95" font-size="10" font-weight="700" fill="var(--viz-warn, #8a5000)">74 ms</text>
  <text x="20" y="129" font-size="10.5" fill="currentColor">OFFSET, page 500</text>
  <rect x="250" y="116" width="85" height="18" rx="3" fill="var(--viz-bad, #a32b23)" opacity="0.75"/>
  <text x="343" y="129" font-size="10" font-weight="700" fill="var(--viz-bad, #a32b23)">690 ms</text>
  <text x="20" y="163" font-size="10.5" fill="currentColor">OFFSET, page 2000</text>
  <rect x="250" y="150" width="340" height="18" rx="3" fill="var(--viz-bad, #a32b23)" opacity="0.75"/>
  <text x="598" y="163" font-size="10" font-weight="700" fill="var(--viz-bad, #a32b23)">2 740 ms</text>
  <text x="20" y="197" font-size="10.5" fill="currentColor">keyset, any page</text>
  <rect x="250" y="184" width="6" height="18" rx="3" fill="var(--viz-good, #1f6b3a)" opacity="0.75"/>
  <text x="264" y="197" font-size="10" font-weight="700" fill="var(--viz-good, #1f6b3a)">7 ms — flat</text>
  <text x="20" y="234" font-size="10.5" fill="var(--muted, #7c6fb0)">OFFSET re-reads and discards every preceding row; keyset seeks straight to the cursor. The gap grows with depth, not with page size.</text>
</svg>
...
A cursor is a contract, and the fields it carries decide which failures the API can detect.

<svg viewBox="0 0 720 266" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="What a cursor must encode, and why: Required, Opaque" style="width:100%;max-width:720px;display:block;margin:1.5rem auto;">
  <title>What a cursor must encode, and why</title>
  <desc>A comparison table. last sort key value: Required yes, Opaque yes. the seek position sort direction: Required yes, Opaque yes. guards a reversed request filter fingerprint: Required yes, Opaque yes. detects a changed bbox mid-walk walk start time: Required partly, Opaque yes. enables drift reporting page number: Required no, Opaque no. meaningless without an offset Encode the cursor as opaque base64 so its shape can change without breaking a client that stored one.</desc>
  <rect x="0" y="0" width="720" height="266" rx="10" fill="var(--surface, #f5f3ff)"/>
  <text x="20" y="28" font-size="12.5" font-weight="700" fill="currentColor">What a cursor must encode, and why</text>
  ...
  <text x="394" y="58" font-size="10" font-weight="700" fill="currentColor">Opaque</text>
  <text x="34" y="88" font-size="10.5" fill="currentColor">last sort key value</text>
  ...
  <text x="460" y="88" font-size="9.5" fill="var(--muted, #7c6fb0)">the seek position</text>
  <line x1="20" y1="98" x2="700" y2="98" stroke="var(--viz-grid, #d8cff0)" stroke-width="1"/>
  <text x="34" y="120" font-size="10.5" fill="currentColor">sort direction</text>
  ...
  <text x="460" y="120" font-size="9.5" fill="var(--muted, #7c6fb0)">guards a reversed request</text>
  <line x1="20" y1="130" x2="700" y2="130" stroke="var(--viz-grid, #d8cff0)" stroke-width="1"/>
  <text x="34" y="152" font-size="10.5" fill="currentColor">filter fingerprint</text>
  ...
  <text x="460" y="152" font-size="9.5" fill="var(--muted, #7c6fb0)">detects a changed bbox mid-walk</text>
  <line x1="20" y1="162" x2="700" y2="162" stroke="var(--viz-grid, #d8cff0)" stroke-width="1"/>
  <text x="34" y="184" font-size="10.5" fill="currentColor">walk start time</text>
  ...
  <text x="460" y="184" font-size="9.5" fill="var(--muted, #7c6fb0)">enables drift reporting</text>
  <line x1="20" y1="194" x2="700" y2="194" stroke="var(--viz-grid, #d8cff0)" stroke-width="1"/>
  <text x="34" y="216" font-size="10.5" fill="currentColor">page number</text>
  ...
  <text x="460" y="216" font-size="9.5" fill="var(--muted, #7c6fb0)">meaningless without an offset</text>
  <text x="20" y="252" font-size="10.5" fill="var(--muted, #7c6fb0)">Encode the cursor as opaque base64 so its shape can change without breaking a client that stored one.</text>
</svg>
